# Название проекта
Привет! Мой проект "Курсач - 3" решает задачи по получению вакансий по 
нужным фильтрам. Вся бэкэнд структура выполняет свои задачи. Данные отгружаются в базу данных. Функционал создает БД.
...
```sh
git clone https://github.com/Jeirom/HeadHunterBD.git 
...
## Разработка
Разработка велась в начале зимы, а снега еще нет! 
